...
A brief overview how Info part of Metaprofitsdao website works.
...
The flow is controlled by [src/state/info/updaters.ts](../src/state/info/updaters.ts). When user navigates through the site more pools and tokens are automatically loaded, (e.g. you click on MATIC token and pools for MATIC are loaded automatically, if you click on BNB-BTCB then BTCB token will be loaded, etc)

...
const Container = styled(Flex)`
  ...
  padding: 12px;
  align-items: center;
  background: linear-gradient(rgb(23 209 156) 0%, rgb(10 145 106) 100%);
...
const PhishingWarningBanner: React.FC = () => {
  ...
  const warningText = t("please make sure you're visiting https://matic.mintyswap.com/ - check the URL carefully.")
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'https://matic.mintyswap.com/'}
          color={text === 'https://matic.mintyswap.com/' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}

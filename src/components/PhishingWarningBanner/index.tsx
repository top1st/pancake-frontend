...
const PhishingWarningBanner: React.FC = () => {
  ...
  const warningText = t("please make sure you're visiting http://dapp.metaprofitsdao.com/ - check the URL carefully.")
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'http://dapp.metaprofitsdao.com/'}
          color={text === 'http://dapp.metaprofitsdao.com/' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}

...
export const mainnetTokens = {
  ...
  // bnb here points to the wmatic contract. Wherever the currency MATIC is required, conditional checks for the symbol 'MATIC' can be used
  bnb: new Token(MAINNET, '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270', 18, 'MATIC', 'MATIC', 'https://www.binance.com/'),
  cake: new Token(
    MAINNET,
    '0xd6473967e52714f26EeDBA1f11296E5051dA85be',
    18,
    'MByte',
    'MetaBytes',

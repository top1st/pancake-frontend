...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and $MINTS pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and $MINTS pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from $MINTS pool', data)
  }

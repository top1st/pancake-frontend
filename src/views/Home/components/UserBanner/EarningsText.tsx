...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and MByte pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and MByte pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from MByte pool', data)
  }

...
const config = (t: ContextApi['t']) => {
  return [
    ...
    },
    {
      ...
      description: [
        t(
          'Soon! The current NFT Market is a basic version (phase 1), with early access to trading Metaprofitsdao NFTs only.',
        ),
    ...
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by Metaprofitsdao from sales are used to buy back and BURN MByte tokens in our weekly MByte burns.',
        ),
        t(
          'Platform fees: 2% is subtracted from NFT sales on the market. Subject to change.Collection fees: Additional fees may be taken by collection creators, once those collections are live. These will not contribute to the MByte burns.',
        ),
      ],
    },
  ]

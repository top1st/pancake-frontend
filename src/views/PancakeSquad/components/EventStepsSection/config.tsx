  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active Metaprofitsdao Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      buttons: (
        <>
          <Button
            as="a"
            href="http://dapp.metaprofitsdao.com//swap?outputCurrency=0xd6473967e52714f26EeDBA1f11296E5051dA85be"
            target="_blank"
            width="100%"
          >
            {t('Buy MByte')}
